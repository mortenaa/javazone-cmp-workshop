 ...
 * browser's localStorage instead — the other side of the expect/actual
 * seam declared in FavoritesStore.kt / ProgramCache.kt.
 */
...
private class LocalStorageProgramCache : ProgramCache {
    ...
    override suspend fun write(programJson: String) {
        localStorage.setItem("javazone.program", programJson)
    }
}
