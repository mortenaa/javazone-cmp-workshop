...
![bg right fit](media/app-overview.png)
...
![bg right fit](media/task-0-result.png)
...
![bg right fit](media/task-1-result.png)
...
![bg right fit](media/task-2-result.png)
...
![bg right fit](media/task-3-result.png)
...
![bg right fit](media/task-4-result.png)
...
![bg right fit](media/task-5-result.png)
...
![bg right fit](media/task-6-result.png)
